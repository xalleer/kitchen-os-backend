...
export function buildRecipePrompt(params: GenerateRecipeParams): string {
  ...
  let prompt = `Створи рецепт страви ВИКЛЮЧНО з таких продуктів (не додавай жодних інших інгредієнтів):
${productNames.join(', ')}
...
**КРИТИЧНО ВАЖЛИВО:**
- Заборонено додавати будь-які інші інгредієнти, яких немає в списку продуктів вище
- У полі "productName" використовуй ТОЧНУ назву зі списку продуктів вище
