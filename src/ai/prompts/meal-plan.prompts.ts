...
- Поле price в каталозі: це ціна за стандартну тару (standardAmount) якщо вона вказана. Якщо standardAmount = 0 або відсутня, базова кількість: G/ML за 1000; PCS за 1 штуку.
